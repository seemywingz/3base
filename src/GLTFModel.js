...
export default class GLTFModel extends MeshObject {
    ...
    initBoundingBoxPhysics() {
        ...
        let w = (helper.geometry.boundingBox.max.x - helper.geometry.boundingBox.min.x) * 0.5;
        let h = (helper.geometry.boundingBox.max.x - helper.geometry.boundingBox.min.x) * 0.5;
        let d = (helper.geometry.boundingBox.max.x - helper.geometry.boundingBox.min.x) * 0.5;
